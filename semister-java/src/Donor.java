...
public class Donor {
	 private String name;
	    ...
	    public static void main(String[] args) throws IOException, ParseException{
	        ...
	        BufferedWriter bf = new BufferedWriter(new FileWriter("C:\Users\Lenovo\18bit0391.txt"));
	        ...
	        BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Lenovo\\18bit0391.txt"));
